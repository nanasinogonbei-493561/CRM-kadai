<x-layouts.app :title="__('Dashboard')">
    <div class="Company-layout">
      <h2>会社一覧</h2>
      <a href="{{ route('companies.create') }}" class="create">新規作成</a>

      <div class="Company-searchForm">
        <h3>会社検索フォーム</h3>
      ...
      <div class="Company-table">
        <table class="Company-table-layout">
          <thead>
            <tr>
          ...
          <tbody>
            @forelse($companies as $hensu)
                <tr>
                  <td class="border px-4 py-2 text-center">{{ $hensu->id }}</td>
                  <td class="border px-4 py-2 text-center">{{ $hensu->name }}</td>
