<x-layouts.app :title="__('Dashboard')">
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
      ...
      @endforeach
      @endif
      <form method="PUT" action="{{ route('contacts.update', $contact->id) }}" class="" >
        @csrf
        <div class="mb-4">
        ...
        <div class="mb-4">
          ...
          <input type="name" name="name" id="name" class="shadow appearance-none border rounded w-full py-2 px-3 text-white-700 leading-tight focus:outline-none focus:shadow-outline" required>
        </div>
        <div class="mb-4">
