        ...
        <table class="Activity-table-layout">
          <thead>
            <tr>
              ...
              <th class="px-4 py-2">メール備考</th>
              <th class="px-4 py-2">備考</th>
              <th class="px-4 py-2">着電日報備考</th>
          ...
          <tbody>
            @forelse($activities as $hensu)
              <tr>
                ...
                <td class="border px-4 py-2 text-center">{{ $hensu->email_notes }}</td>
                <td class="border px-4 py-2 text-center">{{ $hensu->description }}</td>
                <td class="border px-4 py-2 text-center">{{ $hensu->call_notes }}</td>
                <td class="border px-4 py-2 text-center">
                  <input type="checkbox" disabled {{ $hensu->phone_ng ? 'checked' : '' }}>
                </td>
                <td class="border px-4 py-2 text-center">{{ $hensu->last_sales_status }}</td>
                <td class="border px-4 py-2 text-center">
